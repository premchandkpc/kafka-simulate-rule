pub fn merge_json_array<'a>(parts: &[&[u8]], arena: &'a crate::memory::arena::Arena) -> &'a mut [u8] {
...
pub fn extract_json_field<'a>(body: &[u8], field_path: &str, arena: &'a crate::memory::arena::Arena) -> Option<&'a mut [u8]> {
